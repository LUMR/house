...
<DIV id=view class="main wrap">
    <DIV class=intro>
        <DIV class=lefter>
            ...
            <DIV class=houseinfo>
                <P>户　　型：<SPAN>${house.types.name}</SPAN></P>
                <P>面　　积：<SPAN>${house.floorage}m<SUP>2</SUP></SPAN></P>
                <P>位　　置：<SPAN>${house.street.district.name}${house.street.name}</SPAN></P>
        ...
        <DIV class=side>
            ...
            <P>资质证书：有</P>
            <P>内部编号:1000</P>
            <P>联 系 人：${house.user.name}</P>
            <P>联系电话：<SPAN></SPAN></P>
            <P>手机号码：<SPAN>${house.user.telephone}</SPAN></P></DIV>
        <DIV class=clear></DIV>
